...
vector unsigned int outputs[386] __attribute__ ((aligned (128))) = { 0 };
char message[128] __attribute__ ((aligned (128)));
extern char _binary_spu_spu_generic_test_spu_elf_start[];
...
int main(void)
{
	...
	groupArg.thread[0].elf   = (sys_addr_t)_binary_spu_spu_generic_test_spu_elf_start;
