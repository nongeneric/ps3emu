...
#define SAMPLE_NAME "Gloss Map Example"
...
// shader binary 
#define VERTEX_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/vs_gloss.cgelf"
#define FRAGMENT_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/fs_gloss.cgelf"

// shader sources 
#define VERTEX_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/vs_gloss.cg"
#define FRAGMENT_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/fs_gloss.cg"

#define GLOSS_TEXTURE			REMOTE_PATH"images/Tutorial/glossmap.dds"
...
void sampleInit() 
{
  ...
  GLuint texId = gfxLoadDDSTexture(GLOSS_TEXTURE);
