...
#define SAMPLE_NAME "Procedural Vertex Animation Example"
...
// shader binary 
#define VERTEX_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/vs_procAnim.cgelf"
#define FRAGMENT_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/fs_procAnim.cgelf"

// shader sources 
#define VERTEX_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/vs_procAnim.cg"
#define FRAGMENT_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/fs_procAnim.cg"
...
CGparameter 	ModelView_cgParam;	    //uniform parameter in vertex program
...
CGparameter     Counter_cgParam;	//uniform parameter in vertex program for an animation counter
...
#define DEFAULT_VIEW_DIST  	-12.f			// setting up the view distance 

#define NEAR_CLIP	0.1f
#define FAR_CLIP	8500.1f
#define FOV_Y		50.0f			//field of view in the y direction
...
double 			TimeReport = 0;
unsigned int 		Counter = 45;		//frame counter
...
void sampleInit() 
{
  ...
  Object[0].mPos=Vector3(-5.0f, 0.0f, -5.0f);
  Object[1].mPos=Vector3( 0.0f, 0.0f, -5.0f);
  Object[2].mPos=Vector3( 5.0f, 0.0f, -5.0f);
  Object[3].mPos=Vector3(-5.0f, 0.0f,  0.0f);
  Object[4].mPos=Vector3( 0.0f, 0.0f,  0.0f);
  Object[5].mPos=Vector3( 5.0f, 0.0f,  0.0f);
  Object[6].mPos=Vector3(-5.0f, 0.0f,  5.0f);
  Object[7].mPos=Vector3( 0.0f, 0.0f,  5.0f);
  Object[8].mPos=Vector3( 5.0f, 0.0f,  5.0f);

  //initlaize the light
  Light.mPos=Vector3(0.0f,5.0f,0.0f);
  ...
  ModelView_cgParam	= cgGetNamedParameter(VertexProgram, "modelView");		gfxCheckCgError (__LINE__);
  Counter_cgParam	= cgGetNamedParameter(VertexProgram, "counter");		gfxCheckCgError (__LINE__);
...
void sampleRender()
{
  ...
  {	
    ...
    cgGLSetStateMatrixParameter (ModelView_cgParam, CG_GL_MODELVIEW_MATRIX, CG_GL_MATRIX_IDENTITY);	gfxCheckCgError (__LINE__);
    ...
    cgGLSetParameter1f(Counter_cgParam,1.0f*Counter);			gfxCheckCgError(__LINE__);
