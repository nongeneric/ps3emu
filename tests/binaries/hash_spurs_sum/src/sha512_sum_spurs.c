...
int sha512_sum_spu(const char *mount, const char *file, CellSpursTaskset2 *taskset)
{
	#define SHA_QDEPTH 8 
	...
	ret=cellSha512SpuCreateTask2(&inst, taskset, NULL, NULL, SHA_QDEPTH,DMA_BUFFER_SIZE);
