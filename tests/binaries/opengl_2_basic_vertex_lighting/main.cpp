...
#define SAMPLE_NAME "Basic Vertex Lighting Example"
...
// shader binary 
#define VERTEX_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/vs_basicVertex.cgelf"
#define FRAGMENT_PROGRAM_BINARY		REMOTE_PATH"/shaders/Tutorial/fs_basicVertex.cgelf"

// shader sources 
#define VERTEX_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/vs_basicVertex.cg"
#define FRAGMENT_PROGRAM_SOURCE		REMOTE_PATH"/shaders/Tutorial/fs_basicVertex.cg"
...
void sampleInit() 
{
  ...
  LightPos_cgParam	= cgGetNamedParameter (VertexProgram, "lightPos");	gfxCheckCgError (__LINE__);
  LightCol_cgParam	= cgGetNamedParameter (VertexProgram, "lightCol");	gfxCheckCgError (__LINE__);
  Ambient_cgParam	= cgGetNamedParameter (VertexProgram, "ambient");	gfxCheckCgError (__LINE__);
  EyePosLocal_cgParam	= cgGetNamedParameter (VertexProgram, "eyePosLocal");	gfxCheckCgError (__LINE__);
